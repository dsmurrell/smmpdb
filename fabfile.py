...
def deploy():
    with cd('~/smmpdb'):
        ...
        sudo('source /home/dsm38/.virtualenvs/smmpdb/bin/activate && pkill celery')
        sudo('source /home/dsm38/.virtualenvs/smmpdb/bin/activate && celery -A smmpdb worker -l info &')
