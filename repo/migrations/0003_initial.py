...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MoleculeFile'
        db.create_table(u'molecule_file', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('molecule_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('repo', ['MoleculeFile'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'MoleculeFile'
        db.delete_table(u'molecule_file')
    ...
    models = {
        ...
        'repo.moleculefile': {
            'Meta': {'object_name': 'MoleculeFile', 'db_table': "u'molecule_file'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'molecule_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
        'repo.reference': {
